...
\begin{itemize}
    ...
    \item $\rho_{i,h}$: pairwise deviation cap.
\end{itemize}
...
\begin{itemize}
    \item $\omega_h$: household-level adequacy (average utility per household),
    \item $\gamma_n$: nutrient-level adequacy (average utility per nutrient),
    \item $\kappa_{n,h}$: pairwise adequacy (utility per nutrient--household pair).
\end{itemize}

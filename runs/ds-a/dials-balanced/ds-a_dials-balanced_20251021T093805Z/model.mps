...
COLUMNS
     ...
     u(cal_H1) c_u_HouseholdFloor(H1)_ -0.27777777777777779
     u(cal_H1) c_u_HouseholdFloor(H2)_ 0.055555555555555552
     u(cal_H1) c_u_HouseholdFloor(H3)_ 0.055555555555555552
     u(cal_H1) c_u_NutrientFloor(cal)_ -0.27777777777777779
     u(cal_H1) c_u_NutrientFloor(calc)_ 0.055555555555555552
     u(cal_H1) c_u_NutrientFloor(prot)_ 0.055555555555555552
     u(cal_H1) c_u_PairFloor(cal_H1)_ -0.94444444444444442
     u(cal_H1) c_u_PairFloor(cal_H2)_ 0.055555555555555552
     u(cal_H1) c_u_PairFloor(cal_H3)_ 0.055555555555555552
     u(cal_H1) c_u_PairFloor(calc_H1)_ 0.055555555555555552
     u(cal_H1) c_u_PairFloor(calc_H2)_ 0.055555555555555552
     u(cal_H1) c_u_PairFloor(calc_H3)_ 0.055555555555555552
     u(cal_H1) c_u_PairFloor(prot_H1)_ 0.055555555555555552
     u(cal_H1) c_u_PairFloor(prot_H2)_ 0.055555555555555552
     u(cal_H1) c_u_PairFloor(prot_H3)_ 0.055555555555555552
     u(cal_H2) OBJ 1
     u(cal_H2) c_u_U_link(cal_H2)_ 1
     u(cal_H2) c_u_HouseholdFloor(H1)_ 0.055555555555555552
     u(cal_H2) c_u_HouseholdFloor(H2)_ -0.27777777777777779
     u(cal_H2) c_u_HouseholdFloor(H3)_ 0.055555555555555552
     u(cal_H2) c_u_NutrientFloor(cal)_ -0.27777777777777779
     u(cal_H2) c_u_NutrientFloor(calc)_ 0.055555555555555552
     u(cal_H2) c_u_NutrientFloor(prot)_ 0.055555555555555552
     u(cal_H2) c_u_PairFloor(cal_H1)_ 0.055555555555555552
     u(cal_H2) c_u_PairFloor(cal_H2)_ -0.94444444444444442
     u(cal_H2) c_u_PairFloor(cal_H3)_ 0.055555555555555552
     u(cal_H2) c_u_PairFloor(calc_H1)_ 0.055555555555555552
     u(cal_H2) c_u_PairFloor(calc_H2)_ 0.055555555555555552
     u(cal_H2) c_u_PairFloor(calc_H3)_ 0.055555555555555552
     u(cal_H2) c_u_PairFloor(prot_H1)_ 0.055555555555555552
     u(cal_H2) c_u_PairFloor(prot_H2)_ 0.055555555555555552
     u(cal_H2) c_u_PairFloor(prot_H3)_ 0.055555555555555552
     u(cal_H3) OBJ 1
     u(cal_H3) c_u_U_link(cal_H3)_ 1
     u(cal_H3) c_u_HouseholdFloor(H1)_ 0.055555555555555552
     u(cal_H3) c_u_HouseholdFloor(H2)_ 0.055555555555555552
     u(cal_H3) c_u_HouseholdFloor(H3)_ -0.27777777777777779
     u(cal_H3) c_u_NutrientFloor(cal)_ -0.27777777777777779
     u(cal_H3) c_u_NutrientFloor(calc)_ 0.055555555555555552
     u(cal_H3) c_u_NutrientFloor(prot)_ 0.055555555555555552
     u(cal_H3) c_u_PairFloor(cal_H1)_ 0.055555555555555552
     u(cal_H3) c_u_PairFloor(cal_H2)_ 0.055555555555555552
     u(cal_H3) c_u_PairFloor(cal_H3)_ -0.94444444444444442
     u(cal_H3) c_u_PairFloor(calc_H1)_ 0.055555555555555552
     u(cal_H3) c_u_PairFloor(calc_H2)_ 0.055555555555555552
     u(cal_H3) c_u_PairFloor(calc_H3)_ 0.055555555555555552
     u(cal_H3) c_u_PairFloor(prot_H1)_ 0.055555555555555552
     u(cal_H3) c_u_PairFloor(prot_H2)_ 0.055555555555555552
     u(cal_H3) c_u_PairFloor(prot_H3)_ 0.055555555555555552
     u(calc_H1) OBJ 1
     u(calc_H1) c_u_U_link(calc_H1)_ 1
     u(calc_H1) c_u_HouseholdFloor(H1)_ -0.27777777777777779
     u(calc_H1) c_u_HouseholdFloor(H2)_ 0.055555555555555552
     u(calc_H1) c_u_HouseholdFloor(H3)_ 0.055555555555555552
     u(calc_H1) c_u_NutrientFloor(cal)_ 0.055555555555555552
     u(calc_H1) c_u_NutrientFloor(calc)_ -0.27777777777777779
     u(calc_H1) c_u_NutrientFloor(prot)_ 0.055555555555555552
     u(calc_H1) c_u_PairFloor(cal_H1)_ 0.055555555555555552
     u(calc_H1) c_u_PairFloor(cal_H2)_ 0.055555555555555552
     u(calc_H1) c_u_PairFloor(cal_H3)_ 0.055555555555555552
     u(calc_H1) c_u_PairFloor(calc_H1)_ -0.94444444444444442
     u(calc_H1) c_u_PairFloor(calc_H2)_ 0.055555555555555552
     u(calc_H1) c_u_PairFloor(calc_H3)_ 0.055555555555555552
     u(calc_H1) c_u_PairFloor(prot_H1)_ 0.055555555555555552
     u(calc_H1) c_u_PairFloor(prot_H2)_ 0.055555555555555552
     u(calc_H1) c_u_PairFloor(prot_H3)_ 0.055555555555555552
     u(calc_H2) OBJ 1
     u(calc_H2) c_u_U_link(calc_H2)_ 1
     u(calc_H2) c_u_HouseholdFloor(H1)_ 0.055555555555555552
     u(calc_H2) c_u_HouseholdFloor(H2)_ -0.27777777777777779
     u(calc_H2) c_u_HouseholdFloor(H3)_ 0.055555555555555552
     u(calc_H2) c_u_NutrientFloor(cal)_ 0.055555555555555552
     u(calc_H2) c_u_NutrientFloor(calc)_ -0.27777777777777779
     u(calc_H2) c_u_NutrientFloor(prot)_ 0.055555555555555552
     u(calc_H2) c_u_PairFloor(cal_H1)_ 0.055555555555555552
     u(calc_H2) c_u_PairFloor(cal_H2)_ 0.055555555555555552
     u(calc_H2) c_u_PairFloor(cal_H3)_ 0.055555555555555552
     u(calc_H2) c_u_PairFloor(calc_H1)_ 0.055555555555555552
     u(calc_H2) c_u_PairFloor(calc_H2)_ -0.94444444444444442
     u(calc_H2) c_u_PairFloor(calc_H3)_ 0.055555555555555552
     u(calc_H2) c_u_PairFloor(prot_H1)_ 0.055555555555555552
     u(calc_H2) c_u_PairFloor(prot_H2)_ 0.055555555555555552
     u(calc_H2) c_u_PairFloor(prot_H3)_ 0.055555555555555552
     u(calc_H3) OBJ 1
     u(calc_H3) c_u_U_link(calc_H3)_ 1
     u(calc_H3) c_u_HouseholdFloor(H1)_ 0.055555555555555552
     u(calc_H3) c_u_HouseholdFloor(H2)_ 0.055555555555555552
     u(calc_H3) c_u_HouseholdFloor(H3)_ -0.27777777777777779
     u(calc_H3) c_u_NutrientFloor(cal)_ 0.055555555555555552
     u(calc_H3) c_u_NutrientFloor(calc)_ -0.27777777777777779
     u(calc_H3) c_u_NutrientFloor(prot)_ 0.055555555555555552
     u(calc_H3) c_u_PairFloor(cal_H1)_ 0.055555555555555552
     u(calc_H3) c_u_PairFloor(cal_H2)_ 0.055555555555555552
     u(calc_H3) c_u_PairFloor(cal_H3)_ 0.055555555555555552
     u(calc_H3) c_u_PairFloor(calc_H1)_ 0.055555555555555552
     u(calc_H3) c_u_PairFloor(calc_H2)_ 0.055555555555555552
     u(calc_H3) c_u_PairFloor(calc_H3)_ -0.94444444444444442
     u(calc_H3) c_u_PairFloor(prot_H1)_ 0.055555555555555552
     u(calc_H3) c_u_PairFloor(prot_H2)_ 0.055555555555555552
     u(calc_H3) c_u_PairFloor(prot_H3)_ 0.055555555555555552
     u(prot_H1) OBJ 1
     u(prot_H1) c_u_U_link(prot_H1)_ 1
     u(prot_H1) c_u_HouseholdFloor(H1)_ -0.27777777777777779
     u(prot_H1) c_u_HouseholdFloor(H2)_ 0.055555555555555552
     u(prot_H1) c_u_HouseholdFloor(H3)_ 0.055555555555555552
     u(prot_H1) c_u_NutrientFloor(cal)_ 0.055555555555555552
     u(prot_H1) c_u_NutrientFloor(calc)_ 0.055555555555555552
     u(prot_H1) c_u_NutrientFloor(prot)_ -0.27777777777777779
     u(prot_H1) c_u_PairFloor(cal_H1)_ 0.055555555555555552
     u(prot_H1) c_u_PairFloor(cal_H2)_ 0.055555555555555552
     u(prot_H1) c_u_PairFloor(cal_H3)_ 0.055555555555555552
     u(prot_H1) c_u_PairFloor(calc_H1)_ 0.055555555555555552
     u(prot_H1) c_u_PairFloor(calc_H2)_ 0.055555555555555552
     u(prot_H1) c_u_PairFloor(calc_H3)_ 0.055555555555555552
     u(prot_H1) c_u_PairFloor(prot_H1)_ -0.94444444444444442
     u(prot_H1) c_u_PairFloor(prot_H2)_ 0.055555555555555552
     u(prot_H1) c_u_PairFloor(prot_H3)_ 0.055555555555555552
     u(prot_H2) OBJ 1
     u(prot_H2) c_u_U_link(prot_H2)_ 1
     u(prot_H2) c_u_HouseholdFloor(H1)_ 0.055555555555555552
     u(prot_H2) c_u_HouseholdFloor(H2)_ -0.27777777777777779
     u(prot_H2) c_u_HouseholdFloor(H3)_ 0.055555555555555552
     u(prot_H2) c_u_NutrientFloor(cal)_ 0.055555555555555552
     u(prot_H2) c_u_NutrientFloor(calc)_ 0.055555555555555552
     u(prot_H2) c_u_NutrientFloor(prot)_ -0.27777777777777779
     u(prot_H2) c_u_PairFloor(cal_H1)_ 0.055555555555555552
     u(prot_H2) c_u_PairFloor(cal_H2)_ 0.055555555555555552
     u(prot_H2) c_u_PairFloor(cal_H3)_ 0.055555555555555552
     u(prot_H2) c_u_PairFloor(calc_H1)_ 0.055555555555555552
     u(prot_H2) c_u_PairFloor(calc_H2)_ 0.055555555555555552
     u(prot_H2) c_u_PairFloor(calc_H3)_ 0.055555555555555552
     u(prot_H2) c_u_PairFloor(prot_H1)_ 0.055555555555555552
     u(prot_H2) c_u_PairFloor(prot_H2)_ -0.94444444444444442
     u(prot_H2) c_u_PairFloor(prot_H3)_ 0.055555555555555552
     u(prot_H3) OBJ 1
     u(prot_H3) c_u_U_link(prot_H3)_ 1
     u(prot_H3) c_u_HouseholdFloor(H1)_ 0.055555555555555552
     u(prot_H3) c_u_HouseholdFloor(H2)_ 0.055555555555555552
     u(prot_H3) c_u_HouseholdFloor(H3)_ -0.27777777777777779
     u(prot_H3) c_u_NutrientFloor(cal)_ 0.055555555555555552
     u(prot_H3) c_u_NutrientFloor(calc)_ 0.055555555555555552
     u(prot_H3) c_u_NutrientFloor(prot)_ -0.27777777777777779
     u(prot_H3) c_u_PairFloor(cal_H1)_ 0.055555555555555552
     u(prot_H3) c_u_PairFloor(cal_H2)_ 0.055555555555555552
     u(prot_H3) c_u_PairFloor(cal_H3)_ 0.055555555555555552
     u(prot_H3) c_u_PairFloor(calc_H1)_ 0.055555555555555552
     u(prot_H3) c_u_PairFloor(calc_H2)_ 0.055555555555555552
     u(prot_H3) c_u_PairFloor(calc_H3)_ 0.055555555555555552
     u(prot_H3) c_u_PairFloor(prot_H1)_ 0.055555555555555552
     u(prot_H3) c_u_PairFloor(prot_H2)_ 0.055555555555555552
     u(prot_H3) c_u_PairFloor(prot_H3)_ -0.94444444444444442
     ...
     y(apples) c_u_DeviationItemCap(apples)_ -0.5
     y(apples) c_u_DeviationHouseholdCap(H1)_ -0.5
     y(apples) c_u_DeviationHouseholdCap(H2)_ -0.5
     y(apples) c_u_DeviationHouseholdCap(H3)_ -0.5
     y(apples) c_u_DeviationPairCap(apples_H1)_ -0.5
     y(apples) c_u_DeviationPairCap(apples_H2)_ -0.5
     y(apples) c_u_DeviationPairCap(apples_H3)_ -0.5
     ...
     y(milk) c_u_DeviationItemCap(milk)_ -0.5
     y(milk) c_u_DeviationHouseholdCap(H1)_ -0.5
     y(milk) c_u_DeviationHouseholdCap(H2)_ -0.5
     y(milk) c_u_DeviationHouseholdCap(H3)_ -0.5
     y(milk) c_u_DeviationPairCap(milk_H1)_ -0.5
     y(milk) c_u_DeviationPairCap(milk_H2)_ -0.5
     y(milk) c_u_DeviationPairCap(milk_H3)_ -0.5
...
RHS
     ...
     RHS c_u_DeviationItemCap(apples)_ 4
     RHS c_u_DeviationItemCap(beans)_ 6
     RHS c_u_DeviationItemCap(milk)_ 5
     RHS c_u_DeviationItemCap(rice)_ 10
     RHS c_u_DeviationHouseholdCap(H1)_ 25
     RHS c_u_DeviationHouseholdCap(H2)_ 25
     RHS c_u_DeviationHouseholdCap(H3)_ 25
     RHS c_u_DeviationPairCap(apples_H1)_ 4
     RHS c_u_DeviationPairCap(apples_H2)_ 4
     RHS c_u_DeviationPairCap(apples_H3)_ 4
     RHS c_u_DeviationPairCap(beans_H1)_ 6
     RHS c_u_DeviationPairCap(beans_H2)_ 6
     RHS c_u_DeviationPairCap(beans_H3)_ 6
     RHS c_u_DeviationPairCap(milk_H1)_ 5
     RHS c_u_DeviationPairCap(milk_H2)_ 5
     RHS c_u_DeviationPairCap(milk_H3)_ 5
     RHS c_u_DeviationPairCap(rice_H1)_ 10
     RHS c_u_DeviationPairCap(rice_H2)_ 10
     RHS c_u_DeviationPairCap(rice_H3)_ 10

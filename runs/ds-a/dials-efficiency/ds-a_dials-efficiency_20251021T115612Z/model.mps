...
COLUMNS
     ...
     y(apples) c_u_DeviationItemCap(apples)_ -2
     y(apples) c_u_DeviationHouseholdCap(H1)_ -2
     y(apples) c_u_DeviationHouseholdCap(H2)_ -2
     y(apples) c_u_DeviationHouseholdCap(H3)_ -2
     y(apples) c_u_DeviationPairCap(apples_H1)_ -2
     y(apples) c_u_DeviationPairCap(apples_H2)_ -2
     y(apples) c_u_DeviationPairCap(apples_H3)_ -2
     ...
     y(beans) c_u_DeviationItemCap(beans)_ -2
     y(beans) c_u_DeviationHouseholdCap(H1)_ -2
     y(beans) c_u_DeviationHouseholdCap(H2)_ -2
     y(beans) c_u_DeviationHouseholdCap(H3)_ -2
     y(beans) c_u_DeviationPairCap(beans_H1)_ -2
     y(beans) c_u_DeviationPairCap(beans_H2)_ -2
     y(beans) c_u_DeviationPairCap(beans_H3)_ -2
     ...
     y(milk) c_u_DeviationItemCap(milk)_ -2
     y(milk) c_u_DeviationHouseholdCap(H1)_ -2
     y(milk) c_u_DeviationHouseholdCap(H2)_ -2
     y(milk) c_u_DeviationHouseholdCap(H3)_ -2
     y(milk) c_u_DeviationPairCap(milk_H1)_ -2
     y(milk) c_u_DeviationPairCap(milk_H2)_ -2
     y(milk) c_u_DeviationPairCap(milk_H3)_ -2
     ...
     y(rice) c_u_DeviationItemCap(rice)_ -2
     y(rice) c_u_DeviationHouseholdCap(H1)_ -2
     y(rice) c_u_DeviationHouseholdCap(H2)_ -2
     y(rice) c_u_DeviationHouseholdCap(H3)_ -2
     y(rice) c_u_DeviationPairCap(rice_H1)_ -2
     y(rice) c_u_DeviationPairCap(rice_H2)_ -2
     y(rice) c_u_DeviationPairCap(rice_H3)_ -2
...
RHS
     ...
     RHS c_u_DeviationItemCap(apples)_ 16
     RHS c_u_DeviationItemCap(beans)_ 24
     RHS c_u_DeviationItemCap(milk)_ 20
     RHS c_u_DeviationItemCap(rice)_ 40
     RHS c_u_DeviationHouseholdCap(H1)_ 100
     RHS c_u_DeviationHouseholdCap(H2)_ 100
     RHS c_u_DeviationHouseholdCap(H3)_ 100
     RHS c_u_DeviationPairCap(apples_H1)_ 16
     RHS c_u_DeviationPairCap(apples_H2)_ 16
     RHS c_u_DeviationPairCap(apples_H3)_ 16
     RHS c_u_DeviationPairCap(beans_H1)_ 24
     RHS c_u_DeviationPairCap(beans_H2)_ 24
     RHS c_u_DeviationPairCap(beans_H3)_ 24
     RHS c_u_DeviationPairCap(milk_H1)_ 20
     RHS c_u_DeviationPairCap(milk_H2)_ 20
     RHS c_u_DeviationPairCap(milk_H3)_ 20
     RHS c_u_DeviationPairCap(rice_H1)_ 40
     RHS c_u_DeviationPairCap(rice_H2)_ 40
     RHS c_u_DeviationPairCap(rice_H3)_ 40

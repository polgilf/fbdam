...
COLUMNS
     ...
     y(apples) c_u_DeviationItemCap(apples)_ -1
     y(apples) c_u_DeviationHouseholdCap(H1)_ -1
     y(apples) c_u_DeviationHouseholdCap(H2)_ -1
     y(apples) c_u_DeviationHouseholdCap(H3)_ -1
     y(apples) c_u_DeviationPairCap(apples_H1)_ -1
     y(apples) c_u_DeviationPairCap(apples_H2)_ -1
     y(apples) c_u_DeviationPairCap(apples_H3)_ -1
     ...
     y(beans) c_u_DeviationItemCap(beans)_ -1
     y(beans) c_u_DeviationHouseholdCap(H1)_ -1
     y(beans) c_u_DeviationHouseholdCap(H2)_ -1
     y(beans) c_u_DeviationHouseholdCap(H3)_ -1
     y(beans) c_u_DeviationPairCap(beans_H1)_ -1
     y(beans) c_u_DeviationPairCap(beans_H2)_ -1
     y(beans) c_u_DeviationPairCap(beans_H3)_ -1
     ...
     y(milk) c_u_DeviationItemCap(milk)_ -1
     y(milk) c_u_DeviationHouseholdCap(H1)_ -1
     y(milk) c_u_DeviationHouseholdCap(H2)_ -1
     y(milk) c_u_DeviationHouseholdCap(H3)_ -1
     y(milk) c_u_DeviationPairCap(milk_H1)_ -1
     y(milk) c_u_DeviationPairCap(milk_H2)_ -1
     y(milk) c_u_DeviationPairCap(milk_H3)_ -1
     ...
     y(rice) c_u_DeviationItemCap(rice)_ -1
     y(rice) c_u_DeviationHouseholdCap(H1)_ -1
     y(rice) c_u_DeviationHouseholdCap(H2)_ -1
     y(rice) c_u_DeviationHouseholdCap(H3)_ -1
     y(rice) c_u_DeviationPairCap(rice_H1)_ -1
     y(rice) c_u_DeviationPairCap(rice_H2)_ -1
     y(rice) c_u_DeviationPairCap(rice_H3)_ -1
...
RHS
     ...
     RHS c_u_DeviationItemCap(apples)_ 8
     RHS c_u_DeviationItemCap(beans)_ 12
     RHS c_u_DeviationItemCap(milk)_ 10
     RHS c_u_DeviationItemCap(rice)_ 20
     RHS c_u_DeviationHouseholdCap(H1)_ 50
     RHS c_u_DeviationHouseholdCap(H2)_ 50
     RHS c_u_DeviationHouseholdCap(H3)_ 50
     RHS c_u_DeviationPairCap(apples_H1)_ 8
     RHS c_u_DeviationPairCap(apples_H2)_ 8
     RHS c_u_DeviationPairCap(apples_H3)_ 8
     RHS c_u_DeviationPairCap(beans_H1)_ 12
     RHS c_u_DeviationPairCap(beans_H2)_ 12
     RHS c_u_DeviationPairCap(beans_H3)_ 12
     RHS c_u_DeviationPairCap(milk_H1)_ 10
     RHS c_u_DeviationPairCap(milk_H2)_ 10
     RHS c_u_DeviationPairCap(milk_H3)_ 10
     RHS c_u_DeviationPairCap(rice_H1)_ 20
     RHS c_u_DeviationPairCap(rice_H2)_ 20
     RHS c_u_DeviationPairCap(rice_H3)_ 20

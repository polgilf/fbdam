...
COLUMNS
     ...
     u(cal_H1) c_l_HouseholdFloor(H1)_ 0.23333333333333331
     u(cal_H1) c_l_HouseholdFloor(H2)_ -0.10000000000000001
     u(cal_H1) c_l_HouseholdFloor(H3)_ -0.10000000000000001
     u(cal_H1) c_l_NutrientFloor(cal)_ 0.23333333333333331
     u(cal_H1) c_l_NutrientFloor(calc)_ -0.10000000000000001
     u(cal_H1) c_l_NutrientFloor(prot)_ -0.10000000000000001
     u(cal_H1) c_l_PairFloor(cal_H1)_ 0.90000000000000002
     u(cal_H1) c_l_PairFloor(cal_H2)_ -0.10000000000000001
     u(cal_H1) c_l_PairFloor(cal_H3)_ -0.10000000000000001
     u(cal_H1) c_l_PairFloor(calc_H1)_ -0.10000000000000001
     u(cal_H1) c_l_PairFloor(calc_H2)_ -0.10000000000000001
     u(cal_H1) c_l_PairFloor(calc_H3)_ -0.10000000000000001
     u(cal_H1) c_l_PairFloor(prot_H1)_ -0.10000000000000001
     u(cal_H1) c_l_PairFloor(prot_H2)_ -0.10000000000000001
     u(cal_H1) c_l_PairFloor(prot_H3)_ -0.10000000000000001
     u(cal_H2) OBJ 1
     u(cal_H2) c_u_U_link(cal_H2)_ 1
     u(cal_H2) c_l_HouseholdFloor(H1)_ -0.10000000000000001
     u(cal_H2) c_l_HouseholdFloor(H2)_ 0.23333333333333331
     u(cal_H2) c_l_HouseholdFloor(H3)_ -0.10000000000000001
     u(cal_H2) c_l_NutrientFloor(cal)_ 0.23333333333333331
     u(cal_H2) c_l_NutrientFloor(calc)_ -0.10000000000000001
     u(cal_H2) c_l_NutrientFloor(prot)_ -0.10000000000000001
     u(cal_H2) c_l_PairFloor(cal_H1)_ -0.10000000000000001
     u(cal_H2) c_l_PairFloor(cal_H2)_ 0.90000000000000002
     u(cal_H2) c_l_PairFloor(cal_H3)_ -0.10000000000000001
     u(cal_H2) c_l_PairFloor(calc_H1)_ -0.10000000000000001
     u(cal_H2) c_l_PairFloor(calc_H2)_ -0.10000000000000001
     u(cal_H2) c_l_PairFloor(calc_H3)_ -0.10000000000000001
     u(cal_H2) c_l_PairFloor(prot_H1)_ -0.10000000000000001
     u(cal_H2) c_l_PairFloor(prot_H2)_ -0.10000000000000001
     u(cal_H2) c_l_PairFloor(prot_H3)_ -0.10000000000000001
     u(cal_H3) OBJ 1
     u(cal_H3) c_u_U_link(cal_H3)_ 1
     u(cal_H3) c_l_HouseholdFloor(H1)_ -0.10000000000000001
     u(cal_H3) c_l_HouseholdFloor(H2)_ -0.10000000000000001
     u(cal_H3) c_l_HouseholdFloor(H3)_ 0.23333333333333331
     u(cal_H3) c_l_NutrientFloor(cal)_ 0.23333333333333331
     u(cal_H3) c_l_NutrientFloor(calc)_ -0.10000000000000001
     u(cal_H3) c_l_NutrientFloor(prot)_ -0.10000000000000001
     u(cal_H3) c_l_PairFloor(cal_H1)_ -0.10000000000000001
     u(cal_H3) c_l_PairFloor(cal_H2)_ -0.10000000000000001
     u(cal_H3) c_l_PairFloor(cal_H3)_ 0.90000000000000002
     u(cal_H3) c_l_PairFloor(calc_H1)_ -0.10000000000000001
     u(cal_H3) c_l_PairFloor(calc_H2)_ -0.10000000000000001
     u(cal_H3) c_l_PairFloor(calc_H3)_ -0.10000000000000001
     u(cal_H3) c_l_PairFloor(prot_H1)_ -0.10000000000000001
     u(cal_H3) c_l_PairFloor(prot_H2)_ -0.10000000000000001
     u(cal_H3) c_l_PairFloor(prot_H3)_ -0.10000000000000001
     u(calc_H1) OBJ 1
     u(calc_H1) c_u_U_link(calc_H1)_ 1
     u(calc_H1) c_l_HouseholdFloor(H1)_ 0.23333333333333331
     u(calc_H1) c_l_HouseholdFloor(H2)_ -0.10000000000000001
     u(calc_H1) c_l_HouseholdFloor(H3)_ -0.10000000000000001
     u(calc_H1) c_l_NutrientFloor(cal)_ -0.10000000000000001
     u(calc_H1) c_l_NutrientFloor(calc)_ 0.23333333333333331
     u(calc_H1) c_l_NutrientFloor(prot)_ -0.10000000000000001
     u(calc_H1) c_l_PairFloor(cal_H1)_ -0.10000000000000001
     u(calc_H1) c_l_PairFloor(cal_H2)_ -0.10000000000000001
     u(calc_H1) c_l_PairFloor(cal_H3)_ -0.10000000000000001
     u(calc_H1) c_l_PairFloor(calc_H1)_ 0.90000000000000002
     u(calc_H1) c_l_PairFloor(calc_H2)_ -0.10000000000000001
     u(calc_H1) c_l_PairFloor(calc_H3)_ -0.10000000000000001
     u(calc_H1) c_l_PairFloor(prot_H1)_ -0.10000000000000001
     u(calc_H1) c_l_PairFloor(prot_H2)_ -0.10000000000000001
     u(calc_H1) c_l_PairFloor(prot_H3)_ -0.10000000000000001
     u(calc_H2) OBJ 1
     u(calc_H2) c_u_U_link(calc_H2)_ 1
     u(calc_H2) c_l_HouseholdFloor(H1)_ -0.10000000000000001
     u(calc_H2) c_l_HouseholdFloor(H2)_ 0.23333333333333331
     u(calc_H2) c_l_HouseholdFloor(H3)_ -0.10000000000000001
     u(calc_H2) c_l_NutrientFloor(cal)_ -0.10000000000000001
     u(calc_H2) c_l_NutrientFloor(calc)_ 0.23333333333333331
     u(calc_H2) c_l_NutrientFloor(prot)_ -0.10000000000000001
     u(calc_H2) c_l_PairFloor(cal_H1)_ -0.10000000000000001
     u(calc_H2) c_l_PairFloor(cal_H2)_ -0.10000000000000001
     u(calc_H2) c_l_PairFloor(cal_H3)_ -0.10000000000000001
     u(calc_H2) c_l_PairFloor(calc_H1)_ -0.10000000000000001
     u(calc_H2) c_l_PairFloor(calc_H2)_ 0.90000000000000002
     u(calc_H2) c_l_PairFloor(calc_H3)_ -0.10000000000000001
     u(calc_H2) c_l_PairFloor(prot_H1)_ -0.10000000000000001
     u(calc_H2) c_l_PairFloor(prot_H2)_ -0.10000000000000001
     u(calc_H2) c_l_PairFloor(prot_H3)_ -0.10000000000000001
     u(calc_H3) OBJ 1
     u(calc_H3) c_u_U_link(calc_H3)_ 1
     u(calc_H3) c_l_HouseholdFloor(H1)_ -0.10000000000000001
     u(calc_H3) c_l_HouseholdFloor(H2)_ -0.10000000000000001
     u(calc_H3) c_l_HouseholdFloor(H3)_ 0.23333333333333331
     u(calc_H3) c_l_NutrientFloor(cal)_ -0.10000000000000001
     u(calc_H3) c_l_NutrientFloor(calc)_ 0.23333333333333331
     u(calc_H3) c_l_NutrientFloor(prot)_ -0.10000000000000001
     u(calc_H3) c_l_PairFloor(cal_H1)_ -0.10000000000000001
     u(calc_H3) c_l_PairFloor(cal_H2)_ -0.10000000000000001
     u(calc_H3) c_l_PairFloor(cal_H3)_ -0.10000000000000001
     u(calc_H3) c_l_PairFloor(calc_H1)_ -0.10000000000000001
     u(calc_H3) c_l_PairFloor(calc_H2)_ -0.10000000000000001
     u(calc_H3) c_l_PairFloor(calc_H3)_ 0.90000000000000002
     u(calc_H3) c_l_PairFloor(prot_H1)_ -0.10000000000000001
     u(calc_H3) c_l_PairFloor(prot_H2)_ -0.10000000000000001
     u(calc_H3) c_l_PairFloor(prot_H3)_ -0.10000000000000001
     u(prot_H1) OBJ 1
     u(prot_H1) c_u_U_link(prot_H1)_ 1
     u(prot_H1) c_l_HouseholdFloor(H1)_ 0.23333333333333331
     u(prot_H1) c_l_HouseholdFloor(H2)_ -0.10000000000000001
     u(prot_H1) c_l_HouseholdFloor(H3)_ -0.10000000000000001
     u(prot_H1) c_l_NutrientFloor(cal)_ -0.10000000000000001
     u(prot_H1) c_l_NutrientFloor(calc)_ -0.10000000000000001
     u(prot_H1) c_l_NutrientFloor(prot)_ 0.23333333333333331
     u(prot_H1) c_l_PairFloor(cal_H1)_ -0.10000000000000001
     u(prot_H1) c_l_PairFloor(cal_H2)_ -0.10000000000000001
     u(prot_H1) c_l_PairFloor(cal_H3)_ -0.10000000000000001
     u(prot_H1) c_l_PairFloor(calc_H1)_ -0.10000000000000001
     u(prot_H1) c_l_PairFloor(calc_H2)_ -0.10000000000000001
     u(prot_H1) c_l_PairFloor(calc_H3)_ -0.10000000000000001
     u(prot_H1) c_l_PairFloor(prot_H1)_ 0.90000000000000002
     u(prot_H1) c_l_PairFloor(prot_H2)_ -0.10000000000000001
     u(prot_H1) c_l_PairFloor(prot_H3)_ -0.10000000000000001
     u(prot_H2) OBJ 1
     u(prot_H2) c_u_U_link(prot_H2)_ 1
     u(prot_H2) c_l_HouseholdFloor(H1)_ -0.10000000000000001
     u(prot_H2) c_l_HouseholdFloor(H2)_ 0.23333333333333331
     u(prot_H2) c_l_HouseholdFloor(H3)_ -0.10000000000000001
     u(prot_H2) c_l_NutrientFloor(cal)_ -0.10000000000000001
     u(prot_H2) c_l_NutrientFloor(calc)_ -0.10000000000000001
     u(prot_H2) c_l_NutrientFloor(prot)_ 0.23333333333333331
     u(prot_H2) c_l_PairFloor(cal_H1)_ -0.10000000000000001
     u(prot_H2) c_l_PairFloor(cal_H2)_ -0.10000000000000001
     u(prot_H2) c_l_PairFloor(cal_H3)_ -0.10000000000000001
     u(prot_H2) c_l_PairFloor(calc_H1)_ -0.10000000000000001
     u(prot_H2) c_l_PairFloor(calc_H2)_ -0.10000000000000001
     u(prot_H2) c_l_PairFloor(calc_H3)_ -0.10000000000000001
     u(prot_H2) c_l_PairFloor(prot_H1)_ -0.10000000000000001
     u(prot_H2) c_l_PairFloor(prot_H2)_ 0.90000000000000002
     u(prot_H2) c_l_PairFloor(prot_H3)_ -0.10000000000000001
     u(prot_H3) OBJ 1
     u(prot_H3) c_u_U_link(prot_H3)_ 1
     u(prot_H3) c_l_HouseholdFloor(H1)_ -0.10000000000000001
     u(prot_H3) c_l_HouseholdFloor(H2)_ -0.10000000000000001
     u(prot_H3) c_l_HouseholdFloor(H3)_ 0.23333333333333331
     u(prot_H3) c_l_NutrientFloor(cal)_ -0.10000000000000001
     u(prot_H3) c_l_NutrientFloor(calc)_ -0.10000000000000001
     u(prot_H3) c_l_NutrientFloor(prot)_ 0.23333333333333331
     u(prot_H3) c_l_PairFloor(cal_H1)_ -0.10000000000000001
     u(prot_H3) c_l_PairFloor(cal_H2)_ -0.10000000000000001
     u(prot_H3) c_l_PairFloor(cal_H3)_ -0.10000000000000001
     u(prot_H3) c_l_PairFloor(calc_H1)_ -0.10000000000000001
     u(prot_H3) c_l_PairFloor(calc_H2)_ -0.10000000000000001
     u(prot_H3) c_l_PairFloor(calc_H3)_ -0.10000000000000001
     u(prot_H3) c_l_PairFloor(prot_H1)_ -0.10000000000000001
     u(prot_H3) c_l_PairFloor(prot_H2)_ -0.10000000000000001
     ...
     y(apples) c_u_DeviationHouseholdCap(H1)_ -0.011111111111111112
     y(apples) c_u_DeviationHouseholdCap(H2)_ -0.033333333333333333
     y(apples) c_u_DeviationHouseholdCap(H3)_ -0.055555555555555559
     y(apples) c_u_DeviationPairCap(apples_H1)_ -0.011111111111111112
     y(apples) c_u_DeviationPairCap(apples_H2)_ -0.033333333333333333
     y(apples) c_u_DeviationPairCap(apples_H3)_ -0.055555555555555559
     ...
     y(beans) c_u_DeviationHouseholdCap(H1)_ -0.011111111111111112
     y(beans) c_u_DeviationHouseholdCap(H2)_ -0.033333333333333333
     y(beans) c_u_DeviationHouseholdCap(H3)_ -0.055555555555555559
     y(beans) c_u_DeviationPairCap(beans_H1)_ -0.011111111111111112
     y(beans) c_u_DeviationPairCap(beans_H2)_ -0.033333333333333333
     y(beans) c_u_DeviationPairCap(beans_H3)_ -0.055555555555555559
     ...
     y(milk) c_u_DeviationHouseholdCap(H1)_ -0.011111111111111112
     y(milk) c_u_DeviationHouseholdCap(H2)_ -0.033333333333333333
     y(milk) c_u_DeviationHouseholdCap(H3)_ -0.055555555555555559
     y(milk) c_u_DeviationPairCap(milk_H1)_ -0.011111111111111112
     y(milk) c_u_DeviationPairCap(milk_H2)_ -0.033333333333333333
     y(milk) c_u_DeviationPairCap(milk_H3)_ -0.055555555555555559
     ...
     y(rice) c_u_DeviationHouseholdCap(H1)_ -0.011111111111111112
     y(rice) c_u_DeviationHouseholdCap(H2)_ -0.033333333333333333
     y(rice) c_u_DeviationHouseholdCap(H3)_ -0.055555555555555559
     y(rice) c_u_DeviationPairCap(rice_H1)_ -0.011111111111111112
     y(rice) c_u_DeviationPairCap(rice_H2)_ -0.033333333333333333
     y(rice) c_u_DeviationPairCap(rice_H3)_ -0.055555555555555559
...
RHS
     ...
     RHS c_u_DeviationHouseholdCap(H1)_ 0.55555555555555558
     RHS c_u_DeviationHouseholdCap(H2)_ 1.6666666666666665
     RHS c_u_DeviationHouseholdCap(H3)_ 2.7777777777777781
     RHS c_u_DeviationPairCap(apples_H1)_ 0.088888888888888892
     RHS c_u_DeviationPairCap(apples_H2)_ 0.26666666666666666
     RHS c_u_DeviationPairCap(apples_H3)_ 0.44444444444444448
     RHS c_u_DeviationPairCap(beans_H1)_ 0.13333333333333333
     RHS c_u_DeviationPairCap(beans_H2)_ 0.40000000000000002
     RHS c_u_DeviationPairCap(beans_H3)_ 0.66666666666666674
     RHS c_u_DeviationPairCap(milk_H1)_ 0.11111111111111112
     RHS c_u_DeviationPairCap(milk_H2)_ 0.33333333333333331
     RHS c_u_DeviationPairCap(milk_H3)_ 0.55555555555555558
     RHS c_u_DeviationPairCap(rice_H1)_ 0.22222222222222224
     RHS c_u_DeviationPairCap(rice_H2)_ 0.66666666666666663
     RHS c_u_DeviationPairCap(rice_H3)_ 1.1111111111111112

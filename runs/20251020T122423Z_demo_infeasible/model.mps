...
COLUMNS
     ...
     u(cal_H1) c_l_HouseholdFloor(H1)_ 0.22222222222222221
     u(cal_H1) c_l_HouseholdFloor(H2)_ -0.1111111111111111
     u(cal_H1) c_l_HouseholdFloor(H3)_ -0.1111111111111111
     u(cal_H1) c_l_NutrientFloor(cal)_ 0.22222222222222221
     u(cal_H1) c_l_NutrientFloor(calc)_ -0.1111111111111111
     u(cal_H1) c_l_NutrientFloor(prot)_ -0.1111111111111111
     u(cal_H1) c_l_PairFloor(cal_H1)_ 0.88888888888888884
     u(cal_H1) c_l_PairFloor(cal_H2)_ -0.1111111111111111
     u(cal_H1) c_l_PairFloor(cal_H3)_ -0.1111111111111111
     u(cal_H1) c_l_PairFloor(calc_H1)_ -0.1111111111111111
     u(cal_H1) c_l_PairFloor(calc_H2)_ -0.1111111111111111
     u(cal_H1) c_l_PairFloor(calc_H3)_ -0.1111111111111111
     u(cal_H1) c_l_PairFloor(prot_H1)_ -0.1111111111111111
     u(cal_H1) c_l_PairFloor(prot_H2)_ -0.1111111111111111
     u(cal_H1) c_l_PairFloor(prot_H3)_ -0.1111111111111111
     u(cal_H2) OBJ 1
     u(cal_H2) c_u_U_link(cal_H2)_ 1
     u(cal_H2) c_l_HouseholdFloor(H1)_ -0.1111111111111111
     u(cal_H2) c_l_HouseholdFloor(H2)_ 0.22222222222222221
     u(cal_H2) c_l_HouseholdFloor(H3)_ -0.1111111111111111
     u(cal_H2) c_l_NutrientFloor(cal)_ 0.22222222222222221
     u(cal_H2) c_l_NutrientFloor(calc)_ -0.1111111111111111
     u(cal_H2) c_l_NutrientFloor(prot)_ -0.1111111111111111
     u(cal_H2) c_l_PairFloor(cal_H1)_ -0.1111111111111111
     u(cal_H2) c_l_PairFloor(cal_H2)_ 0.88888888888888884
     u(cal_H2) c_l_PairFloor(cal_H3)_ -0.1111111111111111
     u(cal_H2) c_l_PairFloor(calc_H1)_ -0.1111111111111111
     u(cal_H2) c_l_PairFloor(calc_H2)_ -0.1111111111111111
     u(cal_H2) c_l_PairFloor(calc_H3)_ -0.1111111111111111
     u(cal_H2) c_l_PairFloor(prot_H1)_ -0.1111111111111111
     u(cal_H2) c_l_PairFloor(prot_H2)_ -0.1111111111111111
     u(cal_H2) c_l_PairFloor(prot_H3)_ -0.1111111111111111
     u(cal_H3) OBJ 1
     u(cal_H3) c_u_U_link(cal_H3)_ 1
     u(cal_H3) c_l_HouseholdFloor(H1)_ -0.1111111111111111
     u(cal_H3) c_l_HouseholdFloor(H2)_ -0.1111111111111111
     u(cal_H3) c_l_HouseholdFloor(H3)_ 0.22222222222222221
     u(cal_H3) c_l_NutrientFloor(cal)_ 0.22222222222222221
     u(cal_H3) c_l_NutrientFloor(calc)_ -0.1111111111111111
     u(cal_H3) c_l_NutrientFloor(prot)_ -0.1111111111111111
     u(cal_H3) c_l_PairFloor(cal_H1)_ -0.1111111111111111
     u(cal_H3) c_l_PairFloor(cal_H2)_ -0.1111111111111111
     u(cal_H3) c_l_PairFloor(cal_H3)_ 0.88888888888888884
     u(cal_H3) c_l_PairFloor(calc_H1)_ -0.1111111111111111
     u(cal_H3) c_l_PairFloor(calc_H2)_ -0.1111111111111111
     u(cal_H3) c_l_PairFloor(calc_H3)_ -0.1111111111111111
     u(cal_H3) c_l_PairFloor(prot_H1)_ -0.1111111111111111
     u(cal_H3) c_l_PairFloor(prot_H2)_ -0.1111111111111111
     u(cal_H3) c_l_PairFloor(prot_H3)_ -0.1111111111111111
     u(calc_H1) OBJ 1
     u(calc_H1) c_u_U_link(calc_H1)_ 1
     u(calc_H1) c_l_HouseholdFloor(H1)_ 0.22222222222222221
     u(calc_H1) c_l_HouseholdFloor(H2)_ -0.1111111111111111
     u(calc_H1) c_l_HouseholdFloor(H3)_ -0.1111111111111111
     u(calc_H1) c_l_NutrientFloor(cal)_ -0.1111111111111111
     u(calc_H1) c_l_NutrientFloor(calc)_ 0.22222222222222221
     u(calc_H1) c_l_NutrientFloor(prot)_ -0.1111111111111111
     u(calc_H1) c_l_PairFloor(cal_H1)_ -0.1111111111111111
     u(calc_H1) c_l_PairFloor(cal_H2)_ -0.1111111111111111
     u(calc_H1) c_l_PairFloor(cal_H3)_ -0.1111111111111111
     u(calc_H1) c_l_PairFloor(calc_H1)_ 0.88888888888888884
     u(calc_H1) c_l_PairFloor(calc_H2)_ -0.1111111111111111
     u(calc_H1) c_l_PairFloor(calc_H3)_ -0.1111111111111111
     u(calc_H1) c_l_PairFloor(prot_H1)_ -0.1111111111111111
     u(calc_H1) c_l_PairFloor(prot_H2)_ -0.1111111111111111
     u(calc_H1) c_l_PairFloor(prot_H3)_ -0.1111111111111111
     u(calc_H2) OBJ 1
     u(calc_H2) c_u_U_link(calc_H2)_ 1
     u(calc_H2) c_l_HouseholdFloor(H1)_ -0.1111111111111111
     u(calc_H2) c_l_HouseholdFloor(H2)_ 0.22222222222222221
     u(calc_H2) c_l_HouseholdFloor(H3)_ -0.1111111111111111
     u(calc_H2) c_l_NutrientFloor(cal)_ -0.1111111111111111
     u(calc_H2) c_l_NutrientFloor(calc)_ 0.22222222222222221
     u(calc_H2) c_l_NutrientFloor(prot)_ -0.1111111111111111
     u(calc_H2) c_l_PairFloor(cal_H1)_ -0.1111111111111111
     u(calc_H2) c_l_PairFloor(cal_H2)_ -0.1111111111111111
     u(calc_H2) c_l_PairFloor(cal_H3)_ -0.1111111111111111
     u(calc_H2) c_l_PairFloor(calc_H1)_ -0.1111111111111111
     u(calc_H2) c_l_PairFloor(calc_H2)_ 0.88888888888888884
     u(calc_H2) c_l_PairFloor(calc_H3)_ -0.1111111111111111
     u(calc_H2) c_l_PairFloor(prot_H1)_ -0.1111111111111111
     u(calc_H2) c_l_PairFloor(prot_H2)_ -0.1111111111111111
     u(calc_H2) c_l_PairFloor(prot_H3)_ -0.1111111111111111
     u(calc_H3) OBJ 1
     u(calc_H3) c_u_U_link(calc_H3)_ 1
     u(calc_H3) c_l_HouseholdFloor(H1)_ -0.1111111111111111
     u(calc_H3) c_l_HouseholdFloor(H2)_ -0.1111111111111111
     u(calc_H3) c_l_HouseholdFloor(H3)_ 0.22222222222222221
     u(calc_H3) c_l_NutrientFloor(cal)_ -0.1111111111111111
     u(calc_H3) c_l_NutrientFloor(calc)_ 0.22222222222222221
     u(calc_H3) c_l_NutrientFloor(prot)_ -0.1111111111111111
     u(calc_H3) c_l_PairFloor(cal_H1)_ -0.1111111111111111
     u(calc_H3) c_l_PairFloor(cal_H2)_ -0.1111111111111111
     u(calc_H3) c_l_PairFloor(cal_H3)_ -0.1111111111111111
     u(calc_H3) c_l_PairFloor(calc_H1)_ -0.1111111111111111
     u(calc_H3) c_l_PairFloor(calc_H2)_ -0.1111111111111111
     u(calc_H3) c_l_PairFloor(calc_H3)_ 0.88888888888888884
     u(calc_H3) c_l_PairFloor(prot_H1)_ -0.1111111111111111
     u(calc_H3) c_l_PairFloor(prot_H2)_ -0.1111111111111111
     u(calc_H3) c_l_PairFloor(prot_H3)_ -0.1111111111111111
     u(prot_H1) OBJ 1
     u(prot_H1) c_u_U_link(prot_H1)_ 1
     u(prot_H1) c_l_HouseholdFloor(H1)_ 0.22222222222222221
     u(prot_H1) c_l_HouseholdFloor(H2)_ -0.1111111111111111
     u(prot_H1) c_l_HouseholdFloor(H3)_ -0.1111111111111111
     u(prot_H1) c_l_NutrientFloor(cal)_ -0.1111111111111111
     u(prot_H1) c_l_NutrientFloor(calc)_ -0.1111111111111111
     u(prot_H1) c_l_NutrientFloor(prot)_ 0.22222222222222221
     u(prot_H1) c_l_PairFloor(cal_H1)_ -0.1111111111111111
     u(prot_H1) c_l_PairFloor(cal_H2)_ -0.1111111111111111
     u(prot_H1) c_l_PairFloor(cal_H3)_ -0.1111111111111111
     u(prot_H1) c_l_PairFloor(calc_H1)_ -0.1111111111111111
     u(prot_H1) c_l_PairFloor(calc_H2)_ -0.1111111111111111
     u(prot_H1) c_l_PairFloor(calc_H3)_ -0.1111111111111111
     u(prot_H1) c_l_PairFloor(prot_H1)_ 0.88888888888888884
     u(prot_H1) c_l_PairFloor(prot_H2)_ -0.1111111111111111
     u(prot_H1) c_l_PairFloor(prot_H3)_ -0.1111111111111111
     u(prot_H2) OBJ 1
     u(prot_H2) c_u_U_link(prot_H2)_ 1
     u(prot_H2) c_l_HouseholdFloor(H1)_ -0.1111111111111111
     u(prot_H2) c_l_HouseholdFloor(H2)_ 0.22222222222222221
     u(prot_H2) c_l_HouseholdFloor(H3)_ -0.1111111111111111
     u(prot_H2) c_l_NutrientFloor(cal)_ -0.1111111111111111
     u(prot_H2) c_l_NutrientFloor(calc)_ -0.1111111111111111
     u(prot_H2) c_l_NutrientFloor(prot)_ 0.22222222222222221
     u(prot_H2) c_l_PairFloor(cal_H1)_ -0.1111111111111111
     u(prot_H2) c_l_PairFloor(cal_H2)_ -0.1111111111111111
     u(prot_H2) c_l_PairFloor(cal_H3)_ -0.1111111111111111
     u(prot_H2) c_l_PairFloor(calc_H1)_ -0.1111111111111111
     u(prot_H2) c_l_PairFloor(calc_H2)_ -0.1111111111111111
     u(prot_H2) c_l_PairFloor(calc_H3)_ -0.1111111111111111
     u(prot_H2) c_l_PairFloor(prot_H1)_ -0.1111111111111111
     u(prot_H2) c_l_PairFloor(prot_H2)_ 0.88888888888888884
     u(prot_H2) c_l_PairFloor(prot_H3)_ -0.1111111111111111
     u(prot_H3) OBJ 1
     u(prot_H3) c_u_U_link(prot_H3)_ 1
     u(prot_H3) c_l_HouseholdFloor(H1)_ -0.1111111111111111
     u(prot_H3) c_l_HouseholdFloor(H2)_ -0.1111111111111111
     u(prot_H3) c_l_HouseholdFloor(H3)_ 0.22222222222222221
     u(prot_H3) c_l_NutrientFloor(cal)_ -0.1111111111111111
     u(prot_H3) c_l_NutrientFloor(calc)_ -0.1111111111111111
     u(prot_H3) c_l_NutrientFloor(prot)_ 0.22222222222222221
     u(prot_H3) c_l_PairFloor(cal_H1)_ -0.1111111111111111
     u(prot_H3) c_l_PairFloor(cal_H2)_ -0.1111111111111111
     u(prot_H3) c_l_PairFloor(cal_H3)_ -0.1111111111111111
     u(prot_H3) c_l_PairFloor(calc_H1)_ -0.1111111111111111
     u(prot_H3) c_l_PairFloor(calc_H2)_ -0.1111111111111111
     u(prot_H3) c_l_PairFloor(calc_H3)_ -0.1111111111111111
     u(prot_H3) c_l_PairFloor(prot_H1)_ -0.1111111111111111
     u(prot_H3) c_l_PairFloor(prot_H2)_ -0.1111111111111111
     u(prot_H3) c_l_PairFloor(prot_H3)_ 0.88888888888888884
     ...
     y_active(apples) c_u_PurchaseActivation(apples)_ -0.90909090909090906
     y_active(apples) c_u_PurchaseAllocationEnforcement(apples)_ 8
     y_active(beans) c_u_PurchaseActivation(beans)_ -0.83333333333333337
     y_active(beans) c_u_PurchaseAllocationEnforcement(beans)_ 12
     y_active(milk) c_u_PurchaseActivation(milk)_ -1.1111111111111112
     y_active(milk) c_u_PurchaseAllocationEnforcement(milk)_ 10
     y_active(rice) c_u_PurchaseActivation(rice)_ -1
...
RHS
     ...
     RHS c_u_DeviationItemCap(apples)_ 0
     RHS c_u_DeviationItemCap(beans)_ 0
     RHS c_u_DeviationItemCap(milk)_ 0
     RHS c_u_DeviationItemCap(rice)_ 0
     RHS c_u_DeviationHouseholdCap(H1)_ 0
     RHS c_u_DeviationHouseholdCap(H2)_ 0
     RHS c_u_DeviationHouseholdCap(H3)_ 0
